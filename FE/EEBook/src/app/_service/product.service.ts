...
export class ProductService {
  ...
  createProduct(name: string, description: string, price: string, quantity: number, categoryId: number,discount: number, flashSale: number, imageIds: Array<string>): Observable<any> {
  ...
  updateProduct(id: number, name: string, description: string, price: string, quantity: number, categoryId: number,  discount: number, flashSale: number, imageIds: Array<string>): Observable<any> {
