...
export class ProductComponent implements OnInit {
  ...
  openUpdate(data: any) {
    ...
    this.productForm.flashSale = data.flashSale;
  ...
  createProduct() {
    ...
    const {name, description, price, quantity, categoryId, discount, flashSale, imageIds} = this.productForm;
    console.log(this.productForm);
    this.productService.createProduct(name, description, price, quantity, categoryId, discount,flashSale, imageIds).subscribe({
      next: res => {
        this.getListProduct();
        this.showForm = false;
  ...
  updateProduct() {
    ...
    const {id, name, description, price, quantity, categoryId,discount, flashSale, imageIds} = this.productForm;
    console.log(this.productForm);
    this.productService.updateProduct(id, name, description, price, quantity, categoryId, discount, flashSale, imageIds).subscribe({
      next: res => {
        this.getListProduct();
        this.showForm = false;
